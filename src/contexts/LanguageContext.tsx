...
const translations: Record<Language, Record<string, string>> = {
  sk: {
    ...
    'about.learn-more': 'Dozvedieť sa viac o André',
    ...
    'resources.read-more': 'Prečítať celý článok',
  ...
  en: {
    ...
    'about.learn-more': 'Learn more about André',
    ...
    'resources.read-more': 'Read the full article',
